...
# Swaylock
cp "$maindir/dotswaylock/config.template" "/home/$username/.swaylock/config"
...
# Waybar
cp "$maindir/dotconfig/waybar/style.css.template" "/home/$username/.config/waybar/style.css"
for (( i=0; i<${#COL_SCHEME_NAMES[@]}; i++ ))
do
